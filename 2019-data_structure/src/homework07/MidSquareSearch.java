...
public class MidSquareSearch implements Map {
  ...
  public MidSquareSearch(int capacity, float loadFactor) {
    this.entries = new Entry[capacity];
    this.loadFactor = loadFactor;
  }

  public MidSquareSearch(int capacity) {
    this(capacity, 0.75F);
  }

  public MidSquareSearch() {
    this(101);
  }
  ...
  private void rehash() {
    ...
    this.used = this.size;
    this.rehashed++;
    System.out.printf("SQUARE REHASH : %d\n", this.rehashed); // XXX TEST CODE
  }
