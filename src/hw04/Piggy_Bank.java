...
public class Piggy_Bank {
	private static Scanner input = new Scanner (System.in); // main 함수 안에 넣게 되면 Scanner 사용 후 닫아야 하기 때문에 정적 메소드 선언을 했다
